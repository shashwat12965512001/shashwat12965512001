  ...
  const services = [
    {
      ...
      description:
        "Cross-platform mobile apps built with Flutter, delivering smooth performance and modern UI/UX across Android and iOS.",
      features: [
    ...
    },
    {
      ...
      description:
        "Modern, scalable web apps using the MERN stack, Next.js, and Strapi for a seamless user experience and powerful backend.",
      features: [
    ...
    },
    {
      ...
      slug: "custom-backend-solutions",
      description:
        "Robust and secure backend systems with REST APIs, authentication, and database design tailored to your business needs.",
      features: [
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            End-to-end development services to transform ideas into scalable,
                ...
                <CardContent className="relative space-y-6">
                  ...
                  <div className="pt-4">
                    <Link to={`/services/${service.slug}`}>
                      <Button
                        variant="outline"
                        className="w-full border-neon/20 hover:border-neon hover:bg-neon/10"
                      >
                        Learn More
                      </Button>
                    </Link>
