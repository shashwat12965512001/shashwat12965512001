              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-neon/10 to-neon-glow/10 p-8 lg:p-12 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    Koha-inspired Management System
                  </p>
                </div>
              ...
              <div className="p-8 lg:p-12">
                <CardHeader className="p-0 mb-6">
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    A modern, full-featured platform inspired by Koha, built
                    with the MERN stack to digitize library workflows including
                    acquisitions, serials, and circulation. Designed with
                    role-based access, analytics dashboards, and scalable
                    architecture.
                  </p>
                </CardHeader>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-12">
                <CardHeader className="p-0 mb-6">
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    A cross-platform finance tracker built with Flutter, Flask,
                    and Firebase, designed to help users track their
                    income/expenses, visualize spending habits, and make smarter
                    financial decisions.
                  </p>
                </CardHeader>
        ...
        <div className="text-center mt-12">
          ...
          <Link to="/projects">
            <Button
              variant="outline"
              size="lg"
              className="border-neon/20 hover:border-neon hover:bg-neon/10"
            >
              View All Projects
            </Button>
          </Link>
